...
//Send a revision prompt to the AI return updated project
...
export async function chat(req,res){
    ...
    await project.save();
  try{
    //Build compact manifest (path + hash + size) insead of sending all code
       ...
       if(errors.length>0){
        console.error(`[DIFF] Errors applying operations:,errors`);
       }
