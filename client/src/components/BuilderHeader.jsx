import { ArrowLeftIcon,ExternalLinkIcon,Code2Icon,DownloadIcon,EyeIcon,GlobeIcon,Loader2Icon } from 'lucide-react';
...
const BuilderHeader = ({
  ...
  return (
     <header className = "h-12 shrink-0 flex items-center justify-between px-3 border-zinc-200 bg-white">
        <div className = "flex items-center gap-2">
            <button onClick = {onBack} className = 'p-1.5 rounded-md text-zinx-500 hover:text-zinc-950 hover:bg-zinc-100 cursor-pointer'>
